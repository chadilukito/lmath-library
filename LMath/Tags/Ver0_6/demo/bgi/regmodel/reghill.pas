{ ******************************************************************
  ...
  The parameters are: B(1) = Ymax, B(2) = K, B(3) = n
...
const
  ...
  LastPar  = 3;       { Index of last parameter }
...
{ ------------------------------------------------------------------
  ...
  begin
    ...
    SetParamBounds(2, 0, 1000);
    SetParamBounds(3, -10, 10);
  end;
...
begin
  ...
  HillFit(X, Y, 1, N, False, MaxIter, Tol, B, V);
