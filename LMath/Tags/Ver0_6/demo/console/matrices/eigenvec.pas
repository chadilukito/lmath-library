...
{$IFDEF USE_DLL}
  dmath;
{$ELSE}
  utypes, uErrors, ueigvec;
{$ENDIF}    

var
  A         : TMatrix;      { Matrix }
  N         : Integer;      { Dimension of matrix }
  Lambda    : TCompVector;  { Eigenvalues }
...
{ ----------------------------------------------------------------------
  ...
  procedure WriteEigenValue(Lambda : TCompVector; I : Integer);
{ ----------------------------------------------------------------------
  ...
  procedure WriteEigenVector(Lambda : TCompVector;
