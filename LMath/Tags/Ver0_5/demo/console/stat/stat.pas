...
var
  XX, YY           : TVector;  { Data }
  MinM, MinW       : Float;    { Minimal values in men and women }
  MaxM, MaxW       : Float;    { Maximal values in men and women }
...
begin
  ...
  WriteLn('                 Men     Women');
  WriteLn;
  WriteLn('Minimum  : ', MinM:10:4, MinW:10:4);
  WriteLn('Maximum  : ', MaxM:10:4, MaxW:10:4);
