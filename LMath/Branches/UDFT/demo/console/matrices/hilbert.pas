...
{$IFDEF USE_DLL}
  dmath;
{$ELSE}
  utypes, uErrors, ugausjor;
{$ENDIF}    

procedure HilbertSystem(N : Integer; var A : TMatrix);
{ ------------------------------------------------------------------
...
procedure WriteHilbertMatrix(N : Integer; A : TMatrix);
var
  I, J, M : Integer;
begin
...
procedure WriteSolution(ErrCode, N : Integer; A : TMatrix; D : Float);
var
  I, M : Integer;
begin
