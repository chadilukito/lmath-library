...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, ExtCtrls, Spin, Printers, Menus;
...
uses
  { DMath units }
  utypes, uErrors, unlfit, umodels, uinvbeta, uScaling, ustrings, uwinplot,
  { Dialogs }
...
begin
  ...
  if ErrCode <> MathOK then
  begin
    MessageDlg(MathErrMessage, mtError, [mbOk], 0);
    Exit;
  end;
