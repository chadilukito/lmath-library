...
{$IFDEF USE_DLL}
  dmath;
{$ELSE}
  utypes, umeansd, uanova1, ubartlet, unonpar, uinvbeta, uinvgam;
{$ENDIF}   
...
var
  X : TVector;     { Sample }
  Z : TMatrix;     { Sample matrix }
  N : TIntVector;  { Sizes }
  M : TVector;     { Means }
  S : TVector;     { Standard dev. }
...
procedure GetSample(J : Integer; X : TVector);
...
procedure GetSampleMatrix(Z : TMatrix);
