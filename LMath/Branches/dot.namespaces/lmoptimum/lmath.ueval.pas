...
uses
  Objects, SysUtils, lmath.utypes, lmath.uErrors, lmath.uminmax, lmath.umath, 
  lmath.utrigo, lmath.uhyper, lmath.uranmt, lmath.ufact, lmath.ubinom,
  lmath.ugamma, lmath.uigamma, lmath.ubeta, lmath.uibeta, lmath.ulambert, 
  lmath.upoidist, lmath.uexpdist, lmath.uSearchTrees, lmath.unormal, 
  lmath.ugamdist, lmath.uibtdist, lmath.uigmdist, lmath.uinvnorm, 
  lmath.uinvgam, lmath.uinvbeta; 
