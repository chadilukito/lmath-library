...
var
  ...
  M    : TVector;  { Mean vector of original lognormal distribution }
  V    : TMatrix;  { Variance-covariance matrix of original lognormal dist. }
  M0   : TVector;  { Mean vector of auxiliary normal dist. }
  V0   : TMatrix;  { Variance-covariance matrix of auxiliary normal dist. }
  L    : TMatrix;  { Cholesky factor of V0 }
  Z    : TVector;  { Random vector from the auxiliary normal dist. }
  X    : TVector;  { Random vector from the original lognormal dist. }
  F    : Text;     { Output file }
