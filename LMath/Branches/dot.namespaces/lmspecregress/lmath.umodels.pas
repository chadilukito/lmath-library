...
uses
  lmath.utypes, lmath.uErrors, lmath.upolynom, lmath.ulinfit, lmath.umulfit, 
  lmath.usvdfit, lmath.upolfit, lmath.unlfit, lmath.ufracfit, lmath.uexpfit, 
  lmath.uiexpfit, lmath.uexlfit, lmath.ulogifit, lmath.upowfit, lmath.umichfit, 
  lmath.umintfit, lmath.uhillfit, lmath.upkfit, lmath.ugamfit, lmath.uevalfit, 
  lmath.uregtest;
...
begin
  with Model do
    case RegType of
      ...
      REG_PK    : LastParam := 2;
      REG_EVAL  : LastParam := lmath.uevalfit.LastParam;
    end;
end;
...
begin
  with Model do
    case RegType of
      ...
      REG_EVAL  : Name := 'y = ' + lmath.uevalfit.FuncName;
    end;
...
begin
  with Model do
    case RegType of
      ...
      REG_EVAL  : ParamName := lmath.uevalfit.ParamName(I);
    end;
end;
